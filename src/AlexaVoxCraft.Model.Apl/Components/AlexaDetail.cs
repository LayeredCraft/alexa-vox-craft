...
public class AlexaDetail : ResponsiveTemplate, IJsonSerializable<AlexaDetail>
{
    ...
    [JsonPropertyName("button2Theme")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<string>? Button2Theme { get; set; }

    [JsonPropertyName("detailImageAlignment")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [JsonPropertyName("ingredientsHideDivider")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<bool?>? IngredientsHideDivider { get; set; }

    [JsonPropertyName("ingredientsText")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [JsonPropertyName("quaternaryText")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<string>? QuaternaryText { get; set; }

    [JsonPropertyName("scrollViewId")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [JsonPropertyName("ingredientListItems")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public new static void RegisterTypeInfo<T>() where T : AlexaDetail
    {
        ...
        AlexaJsonOptions.RegisterTypeModifier<T>(info =>
        {
            ...
            ingredientListItemsProp?.CustomConverter = new APLValueCollectionConverter<IngredientListItem>(false);
        });
    }
}