...
internal static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor MultipleDefaultHandlers = new DiagnosticDescriptor(
        id: "AVXC001",
    ...
    public static readonly DiagnosticDescriptor MultiplePersistenceAdapters = new DiagnosticDescriptor(
        id: "AVXC002",
    ...
    public static readonly DiagnosticDescriptor NoHandlersFound = new DiagnosticDescriptor(
        id: "AVXC003",
