...
{
    [InterceptsLocation(version: 1, data: "1jBtEtBD8qSkyakn/WASuMoBAABGdW5jdGlvbi5jcw==")]
        ...
        string sectionName = AlexaVoxCraft.MediatR.DI.SkillServiceConfiguration.SectionName)
    {
        ...
        // Request Handlers
        services.AddTransient<AlexaVoxCraft.MediatR.IRequestHandler<AlexaVoxCraft.Model.Request.Type.LaunchRequest>, global::Referenced.Assembly.ReferencedLaunchHandler>();
