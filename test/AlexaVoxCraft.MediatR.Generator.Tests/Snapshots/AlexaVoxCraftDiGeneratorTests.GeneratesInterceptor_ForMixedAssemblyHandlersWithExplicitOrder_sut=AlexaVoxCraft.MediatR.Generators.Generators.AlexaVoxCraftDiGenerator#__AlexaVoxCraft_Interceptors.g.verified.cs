...
{
    [InterceptsLocation(version: 1, data: "XPNH3J0UzVmJEVXn4fmstsoBAABGdW5jdGlvbi5jcw==")]
        ...
        string sectionName = AlexaVoxCraft.MediatR.DI.SkillServiceConfiguration.SectionName)
    {
        ...
        // Request Handlers
        services.AddTransient<AlexaVoxCraft.MediatR.IRequestHandler<AlexaVoxCraft.Model.Request.Type.LaunchRequest>, global::Referenced.Mixed.ZReferencedOrderedLaunchHandler>();
        services.AddTransient<AlexaVoxCraft.MediatR.IRequestHandler<AlexaVoxCraft.Model.Request.Type.LaunchRequest>, global::Sample.Generated.Function.SourceOrderedLaunchHandler>();
