...
{
    [InterceptsLocation(version: 1, data: "fXIXLGeuPVa4r0U3TUS5E6oBAABGdW5jdGlvbi5jcw==")]
        ...
        string sectionName = AlexaVoxCraft.MediatR.DI.SkillServiceConfiguration.SectionName)
    {
        ...
        // Request Handlers
        services.AddTransient<AlexaVoxCraft.MediatR.IRequestHandler<AlexaVoxCraft.Model.Request.Type.LaunchRequest>, global::Sample.Generated.InaccessibleTypes.PublicLaunchHandler>();
